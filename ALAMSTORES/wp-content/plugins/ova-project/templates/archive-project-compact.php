...
<div class="archive_project_compact">
	<div class="container">
		...
		<div class="content">
			...
			<div class="wrap_load_more">
				<span class="load_more" data-max_num_pages="1" data-paged="2" data-category="all"><?php esc_html_e( 'Charger Plus', 'ova-project' ); ?></span>
