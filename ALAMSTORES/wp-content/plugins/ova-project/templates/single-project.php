	...
	<div class="container">
		<div class="single_project">
			...
			<div class="intro">
				...
				<div class="client second_font"><?php echo esc_html($ovapo_client); ?><h1>	
						<?php the_title(); ?>
					</h1></div>
				<div class="social">
					<span class="second_font"><?php esc_html_e( 'PARTAGER:', 'ova-project' ); ?></span>
			...
			<!--	<div class="detail">
					...
					<table>
						<tr class="location">
							...
							<td>
								<span class="title_detail"><?php esc_html_e( 'Options:', 'ova-project' ); ?></span>
						...
						<tr class="area">
							...
							<td>
								<span class="title_detail"><?php esc_html_e( 'Dimensions:', 'ova-project' ); ?></span>
						...
						<tr class="year">
							...
							<td>
								<span class="title_detail"><?php esc_html_e( 'Aventages:', 'ova-project' ); ?></span>
						...
						<tr class="value">
							...
							<td>
								<span class="title_detail"><?php esc_html_e( 'Matière structure:', 'ova-project' ); ?></span>
			...
			<div class="bottom">
				<div class="nav-prev text-left">
					<?php previous_post_link( '%link', '<i class="pointer_flaticon-025-left-arrow-2"></i>' . '<span>'._x( 'PRECEDENT', 'ova-project' ).'</span>' ); ?>
				</div>
				<div class="center">
				...
				<div class="nav-next text-right">
					<?php next_post_link( '%link', '<span>'._x( 'SUIVANT', 'ova-project' ).'</span>' . '<i class="pointer_flaticon-017-right-arrow-2"></i>'  ); ?>
				</div>
			</div> <!-- bottom -->
